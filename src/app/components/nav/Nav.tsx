...
export const Nav = () => {
  ...
  return (
    <nav className="bg-white flex items-center justify-between h-[70px] md:h-20 px-[6%] md:px-[4%] lg:px-[8%] sticky top-0 z-100">
      {/* Logo */}
      <div className="logo">
        <Image
          src={logo}
