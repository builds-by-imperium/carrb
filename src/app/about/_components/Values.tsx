...
const Values = () => {
  return (
    <section className="bg-[#0B3B87] w-full h-auto md:h-[50vh] px-[6%] md:px-[4%] lg:px-[8%] flex justify-center flex-col gap-[21] max-md:py-10 max-md:my-5">
      ...
      <div className="grid max-md:grid-cols-1 grid-cols-2 gap-[35px] md:gap-[59px]">
        <div className="">
          <h3 className="font-medium max-md:text-[24px] text-[32px] text-white">Trust</h3>
